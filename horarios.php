    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="index.php#about">Conheça-me</a></li>
                <li><a class="nav-link scrollto" href="#galery">Galeria de Alunos</a></li>
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
            <div class="col-xl-6 col-lg-8">
                <h1>Horários disponíveis<span>.</span></h1>
            </div>
        </div>
...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>WF Personal</span></strong>. Todos os direitos reservados
        </div>
        <div class="credits">
